...
// Функція генерації вправ для звичайних уроків
function buildRegularExercises(grammarKey: string, lessonId: string): Exercise[] {
  ...
  // GENERIC FALLBACK для інших уроків
  // (Тут ти можеш додати специфічні вправи для решти уроків)
